...
public class Server {
    ...
    private void run(String portNumber) {
        ...
        server.createContext("/user/login", new LoginServiceHandler());

        server.createContext("/clear", new ClearHandler());

        server.createContext("/fill/", new FillUserGenHandler());

        //Generate family tree.
        //Make everyone born a few years before. Keep it simple
        //Start at 2000 do 30 years earlier every person.
