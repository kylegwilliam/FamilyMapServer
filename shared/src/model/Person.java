...
public class Person {
    ...
    /**
     * All the variables that are going to be passed in by the database for the Persons Class
    ...
    /**
     * The constructor for the Persons class.
     *
     * There is a list of getters and setters down below for each of the param's
     *
     * @param personID
